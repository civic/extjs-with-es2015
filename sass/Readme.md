...
folder are mapped to the application's root namespace, 'ExtJSWithES2015'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtJSWithES2015"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJSWithES2015' in the same way
as `"ExtJSWithES2015/sass/src"`.
